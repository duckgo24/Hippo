...
const CreatePost = React.forwardRef(({ onCloseForm, onCreateSuccess }, ref) => {
      ...
      return (
            <div className="absolute top-1/2 left-1/2 z-50 transform -translate-x-1/2 -translate-y-1/2 bg-white shadow-lg rounded-lg flex flex-col">
                  <Box height={500} width={800} borderRadius={4} padding="15px 20px" position="relative">
                        <div className="flex justify-between">
                              ...
                              <div className="flex gap-3">
                                    <button onClick={handleCreatePost} disabled={!text}>
                                          <Paragraph
                                                className={cx('btn-share')}
                                                bold="500"
                                                size="14px"
                                                color={image && video ? '#000' : 'rgba(0,0,0, 0.3)'}
                                          >
                                                Chia sẻ
                                          </Paragraph>
                                    </button>
                  ...
                  <div className="relative h-8">
                        <input type="file" ref={fileInputRef} style={{ display: 'none' }} onChange={handleChangeImage} />
                        <button
                              style={{
                                    position: 'absolute',
                                    top: '0%',
