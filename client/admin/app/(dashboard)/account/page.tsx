...
export default function AccountTable() {
    ...
    const { data: accountData, isSuccess: isFetchAccountSuccess, refetch } = useQuery({
    ...
    return (
        <Paper sx={{ width: "95%", overflow: "hidden" }} className="mx-auto mt-10 px-2 py-5 shadow-lg">
                            ...
                            <TableRow hover role="checkbox" tabIndex={-1} key={acc.acc_id}>
                                ...
                                <TableCell align="center">
                                    <div className="flex justify-center space-x-2">
                                        <button onClick={() => handleUpdateAccount(acc)} className="text-green-500">Edit</button>
                                        <button onClick={() => handleDeleteAccount(acc)} className="text-red-500">Delete</button>
                                    </div>
                                </TableCell>
                            </TableRow>
                        ))}
            ...
            <TablePagination
                ...
                component="div"
                count={accountData?.total_records || 0}
